...
<div class="container mt-5 d-flex justify-content-center flex-wrap">
    ...
    <div class="personal-info ms-2">
        <h2>Подтверждённые заявления</h2>
        <a href="{{ route('admin.success', ['sort_field' => 'created_at', 'sort_order' => 'asc']) }}">Сортировать по возрастанию</a>
        <a href="{{ route('admin.success', ['sort_field' => 'created_at', 'sort_order' => 'desc']) }}">Сортировать по убыванию</a>
